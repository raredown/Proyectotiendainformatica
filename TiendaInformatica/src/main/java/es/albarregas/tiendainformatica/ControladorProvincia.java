...
public class ControladorProvincia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //if (request.getParameter("direccion") != null) {
            ...
            IProvincia ipro = daof.getProvincia();
            ArrayList<Provincia> provincias = new ArrayList();
            provincias = ipro.getProvincia("");
            request.setAttribute("provincias",provincias);
            request.getRequestDispatcher("jsp/direccion/dirreccionProvincia.jsp").forward(request, response);
